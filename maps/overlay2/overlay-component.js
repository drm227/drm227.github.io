define([
    ...
    function OverlayComponentVM (params) {
        ...
        config.maps.forEach(function(map){
            ...
            _this.leftLayers[map.name]    = L.tileLayer(map.tileURL /*,{maxNativeZoom:16}*/);
        ...
        setTimeout(function(){
            $('input.leaflet-sbs-range').attr('aria-label','use the arrow keys to move the slider left or right');
        }, 0);
    }
